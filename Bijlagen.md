...
### <a name="api-06"></a>API-06: Alleen standaard HTTP-operaties worden toegepast
...
### <a name="api-07"></a>API-07: Definitie van het koppelvlak is in het Nederlands tenzij er sprake is van een officieel Engelstalig begrippenkader
...
### <a name="api-08"></a>API-08: Resource namen zijn zelfstandige naamwoorden in het meervoud
...
### <a name="api-09"></a>API-09: Relaties van geneste resources worden binnen het eindpunt gecreëerd
...
### <a name="api-10"></a>API-10: Resources ondersteunen "lazy" en "eager" laden van relaties
...
### <a name="api-11"></a>API-11: Gelinkte resources worden expliciet en selectief mee-geladen
...
### <a name="api-12"></a>API-12: Representatie op maat wordt ondersteund
...
### <a name="api-13"></a>API-13: Acties die niet passen in het CRUD model worden een sub-resource
...
### <a name="api-14"></a>API-14: De verbinding is ALTIJD versleuteld met minimaal TLS V1.2
...
### <a name="api-17"></a>API-17: Autorisatie is gebaseerd op OAuth 2.0
...
### <a name="api-18"></a>API-18: Authenticatie voor API's met toegangsbeperking of doelbinding is gebaseerd op PKIoverheid
...
### <a name="api-19"></a>API-19: Documentatie is gebaseerd op OAS 3.0 of hoger

Specificaties (documentatie) is beschikbaar als Open API Specification (OAS) V3.0 of hoger.

### <a name="api-20"></a>API-20: Documentatie is in het Nederlands tenzij er sprake is van bestaande documentatie in het Engels of er sprake is van een officieel Engelstalig begrippenkader
...
### <a name="api-21"></a>API-22: Wijzigingen worden gepubliceerd met een uitfaseringschema
...
### <a name="api-23"></a>API-23: De overgangsperiode bij een nieuwe API versie is maximaal 1 jaar

Oude en nieuwe versies (max. 3) van een API worden voor een beperkte overgangsperiode (1 jaar) naast elkaar aangeboden.

### <a name="api-24"></a>API-24: Alleen het major versienummer is onderdeel van de URI
...
### <a name="api-25"></a>API-25: Gebruikers van een ‘deprecated' API worden actief gewaarschuwd
...
### <a name="api-26"></a>API-26: JSON first - API's ontvangen en versturen JSON

API's ontvangen en versturen JSON.

### <a name="api-27"></a>API-27: API's zijn optioneel voorzien van een JSON Schema

API's ondersteunen JSON Schema (<http://json-schema.org),> zodat validatie mogelijk (optioneel) is en vereenvoudigd wordt.

### <a name="api-28"></a>API-28: Content negotiation wordt volledig ondersteund
...
### <a name="api-29"></a>API-29: API's controleren dat de Content-Type header is ingesteld
...
### <a name="api-30"></a>API-30: Woorden in veldnamen zijn gedefinieerd in `camelCase`

Een veldnaam begint met kleine letters (eerste woord) en ieder opvolgend woord begint met een hoofdletter.

### <a name="api-31"></a>API-31: Pretty print is standaard uitgeschakeld

Het uitgangspunt is dat REST clients en browsers (al dan niet met extensies) JSON netjes geformatteerd kunnen weergeven.

### <a name="api-32"></a>API-32: Een JSON-response heeft geen omhullende envelop

Er worden standaard geen enveloppen toegepast.

### <a name="api-33"></a>API-33: API's ondersteunen JSON gecodeerde POST, PUT en PATCH payloads
...
### <a name="api-34"></a>API-34: Filter query-parameters zijn gelijk aan de velden waarop gefilterd kan worden

Gebruik unieke query-parameters die gelijk zijn aan de velden waarop gefilterd kan worden.

### <a name="api-35"></a>API-35: Voor sorteren wordt de query-parameter sorteer gebruikt
...
### <a name="api-36"></a>API-36: Voor vrije-tekst zoeken wordt een query-parameter zoek gebruikt

API's die vrije-tekst zoeken ondersteunen doen dit middels de query-parameter `zoek`.

### <a name="api-37"></a>API-37: API's die vrije-tekst zoeken ondersteunen kunnen overweg met twee soorten wildcard karakters: `*` en `?`
...
### <a name="api-41"></a>API-41: POST end-points zijn uitbreidbaar voor gecombineerde vragen
...
### <a name="api-44"></a>API-44: Het coördinatenstelsel (CRS) van de vraag en het antwoord wordt in de header meegestuurd
...
### <a name="api-45"></a>API-45: Het gewenste coördinatenstelsel wordt op basis van content negotiation overeengekomen
...
### <a name="api-46"></a>API-46: Paginering wordt gerealiseerd op basis van JSON+HAL
...
### <a name="api-47"></a>API-47: Waar relevant wordt caching toegepast
...
### <a name="api-48"></a>API-48: Beperken van het aantal verzoeken per tijdsperiode wordt aangeraden
...
### <a name="api-49"></a>API-49: Begrenzingen worden proactief gemeld
...
### <a name="api-50"></a>API-50: Foutafhandeling is gestandaardiseerd
...
### <a name="api-51"></a>API-51: API's passen de verplichte HTTP-statuscodes toe

De volgende http-statuscodes worden minimaal toegepast: 200, 201, 204, 304, 400, 401, 403, 405, 406, 409, 410, 415, 422, 429, 500, 503.

### <a name="api-60"></a>API-60: API-endpoints mogen géén trailing slashes bevatten
...
### <a name="api-61"></a>API-61: Gebruik "publieke" API-Key
...
### <a name="api-62"></a>API-62: Controleer toegang en gebruik CORS-header
...
### <a name="api-63"></a>API-63: OAS via basis-URI beschikbaar in JSON-formaat
