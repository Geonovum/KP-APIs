...
<div class="rule" id="api-64">
  ...
  <p>Use nested JSON objects (eg. <pre>adres.straat</pre>) instead of compound words (eg. <pre>adres_straat</pre>) to represent information that is hierarchically related.</p>
</div>
