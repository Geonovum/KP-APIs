...
- Exchange format (notation) for ETRS89 and CRS84 (longitude latitude) in decimal degrees: DD.dddddddd (for example: `5.96237626, 52.25502345`), where 'DD' indicate the number of decimals of the whole part and '.dddddddd' indicate the number of decimals of the fractional part. The number of decimals in the fractional part may vary depending on the required accuracy. For an accuracy of 1 mm, 8 decimals in the fractional part are sufficient. See [[hr-crs]].
- Exchange format (notation) for RD X, Y in meters: XXXXXX.xxx, YYYYYY.yyy (for example: `195427.520, 311611.840`), where 'XXXXXX' and 'YYYYYY' indicate the number of decimals of the whole part and '.xxx' and '.yyy' indicate the number of decimals of the fractional part. The number of decimals in the fractional part may vary depending on the required accuracy. For an accuracy of 1 mm, 3 decimal places in the fractional part are sufficient. See [[hr-crs]].
