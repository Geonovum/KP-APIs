...
* The RSASSA-PKCS1-v1_5 Algorithm with SHA-256  MUST be supported, with a key length of at least 256 bits. The value "RS256" for the alg parameter MUST be used in this case as defined in [[RFC7518]].
* The RSASSA-PSS Algorithm  SHOULD be supported and is RECOMMENDED for use, with a key length of at least 256 bits. The value "PS256" for the alg parameter MUST be used in this case as defined in [[RFC7518]].
